            ...
            {isEditMode ? (
              ...
              <div className="space-y-4">
                ...
                <div className="text-xs text-muted-foreground">
                  {story.isAnonymous ? 'Posted anonymously' : `Posted by ${story.author.toString().slice(0, 8)}...`}
                  {' · '}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="comment-anonymous" className="text-xs">Anonymous</Label>
                      </div>
                      <Button
                        size="sm"
                        ...
                        className="ml-auto"
                      >
                        {isCommentLoading && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
                        Post Comment
                      </Button>
                    </div>
                  </div>
