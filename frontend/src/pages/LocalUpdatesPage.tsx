...
export default function LocalUpdatesPage({ onBackHome }: LocalUpdatesPageProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-8rem)] gap-0">
          ...
          <div className="p-4 space-y-4">
            ...
            {showLocationDenied && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  <p className="text-sm font-semibold mb-1">{locationCopy.title}</p>
            ...
            <div className="p-3 rounded-lg bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20 border">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  <p className="font-medium text-foreground">Real-time local alerts</p>
                  <p>Get notified about traffic, events, and more happening near you.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {identity && (
        <LocalUpdatesFAB onClick={handleCreateClick} />
      )}
