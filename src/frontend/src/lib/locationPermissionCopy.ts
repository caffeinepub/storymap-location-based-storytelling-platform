export const locationPermissionCopy = {
  ...
  unsupported: {
    ...
    description:
      "Your browser does not support geolocation. Please use the map picker or enter coordinates manually.",
  ...
  insecure: {
    ...
    description:
      "Location access requires HTTPS or localhost. Please use the map picker or enter coordinates manually.",
    action: "Enter Manually",
    secondaryAction: undefined,
  },
} as const;
